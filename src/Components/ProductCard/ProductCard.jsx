...
const ProductCard = ({ product }) => {
  ...
  return (
    <div
      ...
      className="flex relative lg:w-72 md:w-52 flex-col items-center text-center border rounded-sm"
    >
      <div className="relative">
        <img
          src={product.thumbnail}
          alt={product.productName}
          className="lg:w-72 lg:h-72 md:w-52 md:h-52 w-full  object-cover"
        />
      </div>
