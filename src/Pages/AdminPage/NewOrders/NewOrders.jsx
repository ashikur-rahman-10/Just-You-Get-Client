    ...
    <div className="py-12 lg:py-0 bg-gray-50 px-4 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-auto w-fit text-xs py-10">
        {handleSort().map((order) => (
          <div
            key={order._id}
            className="relative w-[360px] md:w-[300px]  h-52 bg-white rounded-lg p-4 shadow-sm shadow-sky-400 border-r-4  border-b-4 border-sky-400"
          >
            <div className="pb-2">
              ...
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="bg-green-500 px-2 py-1 rounded-md text-white uppercase font-medium hover:bg-green-600 flex items-center gap-1"
                >
                  Packed <PiPackageFill className="text-lg" />{" "}
                </button>
              </div>
            </div>
