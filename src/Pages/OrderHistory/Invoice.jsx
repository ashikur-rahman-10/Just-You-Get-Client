  ...
  const downloadPdf = () => {
    ...
    html2canvas(input, { useCORS: true, scale: 2 })
      .then((canvas) => {
        ...
        pdf.save(`JYG Invoice-${transactionId}.pdf`);
      })
      .catch((error) => {
  ...
  return (
    <div className="py-4 flex flex-col justify-between px-2 max-w-7xl mx-auto ">
      ...
      <div className="w-full flex items-end h-fit justify-center my-8">
        <button onClick={downloadPdf} className="px-4 btn btn-sm btn-primary ">
            ...
            <div className="">
              ...
              <div className="space-y-1">
                <p className="flex items-center gap-1">
                  <FaMapMarkerAlt></FaMapMarkerAlt> Address: Mirpur 10,Block
                  D,Dhaka
                </p>
                <p className="flex items-center gap-1">
                  <FaPhoneAlt></FaPhoneAlt> Mobile: +8801644976404
                </p>
                <p className="flex items-center gap-1 pb-2">
                  <FaGlobe></FaGlobe> Website:{" "}
                  <a href="https://just-you-get.web.app">
                    https://just-you-get.web.app
                  </a>
                </p>
              </div>
              <hr />
          ...
          <div className="w-full rounded-md text-xs">
            <div className="w-full flex flex-col gap-3 pt-4">
              {order?.products?.map((product) => (
                <div
                  ...
                  className="w-full flex justify-between gap-4 border-b p-2 items-center "
                >
                  <div className="flex gap-2 items-center">
                    ...
                    />
                    <div>
                      <h3 className="font-medium py-[4px]">
                        {product.productName}
                      </h3>
                  ...
                  <div className="flex justify-between w-[25%]">
                    ...
                    <p>
                      {product.discountedPrice}*{product?.itemCount}=
                      {product.itemCount * product.discountedPrice}tk
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="flex w-full justify-end items-center text-xs">
              <div className="relative w-full flex flex-col items-end pr-2 pt-4  text-gray-600">
                ...
                <p className=" py-[4px]">
                  Delivery Cost: + {order?.deliveryCost}tk
                </p>
