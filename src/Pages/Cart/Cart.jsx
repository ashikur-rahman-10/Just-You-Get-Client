...
const Cart = () => {
  ...
  const handleDelete = async (selectedId) => {
    const selectedItem = cart.find((item) => item.productId === selectedId);
    try {
  ...
  const handlePlaceOrder = async () => {
    const selectedItemsArray = userCart.filter(
          ...
          <div className="font-mono w-full max-w-4xl mx-auto relative">
                      ...
                      <tr key={item._id}>
                        ...
                        <td className=" flex flex-col items-start justify-between  gap-1">
                          ...
                          <p className="flex items-center gap-2 justify-center ">
                            <button
                              onClick={() =>
                                handleItemCountChange(item._id, -1)
                              }
            ...
            <div className="w-full max-w-4xl flex gap-4 justify-end bottom-0 fixed px-3">
              ...
              <button
                ...
                className="bg-blue-500 px-5 py-3 text-white font-semibold rounded-sm my-3 hover:bg-blue-600 hover:shadow-md hover:shadow-blue-300 uppercase"
              >
                Place Order
              </button>
            </div>
